...
/*
  Generated class for the AuthorsTap page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-authors-tap',
  templateUrl: 'authors-tap.html',
  providers:[ApiService]

})
export class AuthorsTapPage {
  ...
  getAuthor($event,item){
    this.navCtrl.push(this.author ,{id : item ,type:'tab'});
  }
  refreshPage(){
    this.navCtrl.pop();
    this.navCtrl.push(AuthorsTapPage);
  }
